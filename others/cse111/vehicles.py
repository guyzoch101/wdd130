def main():
    ...
    if vin in vehicles_dict:
        ...
        inner_list = vehicles_dict[vin]

        # Print the manufacturer, model, and color of the vehicle.
        # Don't print the year, engine design, or displacement.
        manufacturer = inner_list[MANUFACTURER_INDEX]
        model = inner_list[MODEL_INDEX]
        colour = inner_list[COLOR_INDEX]
        
        print(f"{manufacturer} {model} {colour}")
